...
namespace GameStore.Controllers
{
    public class GameController : Controller
    {
        ...
        public GameController(GeneralContext context)
        {
            _context = context;
        }
        ...
        {
            var generalContext = _context.Games.Include(g => g.developer).Include(g => g.publisher);
        ...
        public async Task<IActionResult> Create([Bind("id,name,description,imageUrl,price,developerId,publisherId")] Game game)
        {
